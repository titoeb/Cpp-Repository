...
Hex::Hex(int size, string player_blue, string player_red):size(size),player_blue(player_blue), player_red(player_red), PlayerRed(hexGraph(size)), PlayerBlue(hexGraph(size)){}
// print method
void Hex::print(){
